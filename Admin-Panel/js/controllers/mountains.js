myApp.controller('MountainsController', ['$scope', '$firebaseArray', function($scope, $firebaseArray) {
  var myMountains = new Firebase('https://discovermalawi.firebaseio.com/mountains');
    $scope.mountains = $firebaseArray(myMountains);
    ...
    $scope.editFormSubmit = function(){
        ...
        var record = $scope.mountains.$getRecord(id); //to store the whole park we're editing
